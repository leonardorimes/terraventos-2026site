...
// 1. Update public/properties-data.json
const jsonPath = 'public/properties-data.json';
const data = JSON.parse(fs.readFileSync(jsonPath, 'utf8'));
data.unshift(newProperty);
fs.writeFileSync(jsonPath, JSON.stringify(data, null, 2));

// 2. Update src/data/oportunidadesDataI18n.ts
// It's a bit harder to update the TS file properly via JS. We can parse it as a string.
// Let's create the TS string block for the new items.
const tsPt = `    {
      id: '13',
